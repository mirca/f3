...
class star(object):
    ...
    def find_other_sources(self,  edge_lim = 0.015, min_val = 5000,
        ...
        Args:
            edge_lim: The initial limit for the creation of apertures.
            The aperture will be a region of contiguous pixels with flux values larger than the product of ``edge_lim`` and the brightest
